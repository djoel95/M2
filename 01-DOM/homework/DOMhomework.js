...
// Tu código acá:
document.querySelector('#createdBy').innerHTML += ' BuhoPsyco';
...
function addToDo() {
  ...
  toDoInput.value = ''; // Limpiar el contenido del input
  displayToDos(); // Mostrar los elementos actualizados en pantalla
}
